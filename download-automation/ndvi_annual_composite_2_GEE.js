...
var maskL57SR = function(image) {
  ...
  var ndvi_reduced = ndvi.mean().clip(region)
  var ndvi_reduced_l8 = ndviL8.mean().clip(region)
  
  print('reduced ndvi', ndvi_reduced.select('NDVI'));
  
  Map.addLayer(ndvi_reduced.select('NDVI'), {}, 'ndvi reduced');
